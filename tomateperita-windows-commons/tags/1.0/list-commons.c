...
#include "list-commons.h"
	...
	void removeElement(SortedList * list , unsigned int index 
		...
		if(aux != NULL && aux->index == index){
			...
			//TODO: corregir bug de esta parte con respecto a la liberacion de la 
			//TODO: memoria. Se esta eliminando el heap y despues se intenta en el 
			//TODO: segundo if usarlo para eliminar el nodo de la lista !!!!
