...
#define VDA_CONFIGURATION_KEY_VDA_LOGLEVEL			"vda.configuration.key.log.level"
#define VDA_CONFIGURATION_KEY_VDA_DBDIR				"vda.configuration.key.database.location"
//#define VDA_CONFIGURATION_KEY_VDA_LOGDIR			"vda.configuration.key.log.location"
